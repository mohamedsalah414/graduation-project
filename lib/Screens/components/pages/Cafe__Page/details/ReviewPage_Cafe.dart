...
class ReviewPage_Cafe extends StatefulWidget {
  //const ReviewPage_Cinema({Key? key}) : super(key: key);
  @override
  _ReviewPage_CafeState createState() => _ReviewPage_CafeState();
}

class _ReviewPage_CafeState extends State<ReviewPage_Cafe> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('cafereviews').snapshots();
