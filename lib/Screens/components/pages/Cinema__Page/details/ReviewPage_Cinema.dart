...
class ReviewPage_Cinema extends StatefulWidget {
  //const ReviewPage_Cinema({Key? key}) : super(key: key);
  @override
  _ReviewPage_CinemaState createState() => _ReviewPage_CinemaState();
}

class _ReviewPage_CinemaState extends State<ReviewPage_Cinema> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('cinemareviews').snapshots();
