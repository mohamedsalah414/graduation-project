...
import 'Nearby_location_Cinema.dart';



// ignore: camel_case_types
class Location_Page_Cinema extends StatelessWidget {
  const Location_Page_Cinema({
    Key key,
  }) : super(key: key);
  @override
            ...
            SizedBox(
              ...
              child: RaisedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Nearby_location_Cinema()),
                  );
                },
              ),
            ),
